                    ...
                    <div>
                        <details class="details receipt-get-details" @empty(Request::get('receipt-position')) open @endempty>
                            ...
                            <div class="receipt-get-details__content">
                                <label class="label">
                                    ...
                                    <input class="input input-product__disable" type="text" name="filterLIKE[products.name]" value="{{ Request::get('filterLIKE')['products.name'] ?? null }}">
                                </label>
                                <label class="checbox">
                                    <input class="checbox__input" name="exact_title" id="exact_title" @checked(Request::get('exact_title')) type="checkbox">
                                ...
                                <div class="receipt-get__col">
                                    <label class="label">
                                        ...
                                        <input class="input" type="number" name="filterGEQ[products.quantity]" value="{{ Request::get('filterGEQ')['products.quantity'] ?? null }}">
                                    </label>
                                    <label class="label">
                                        <span class="label__title">Количество до</span>
                                        <input class="input" type="number" name="filterLEQ[products.quantity]" value="{{ Request::get('filterLEQ')['products.quantity'] ?? null }}">
                                    </label>
                                </div>
                                <div class="receipt-get__col">
                                    <label class="label">
                        ...
                        <details class="details receipt-get-details" @empty(Request::get('receipt-data')) open @endempty>
                            ...
                            <div class="receipt-get-details__content">
                                <label class="label">
                                    ...
                                    <input class="input" type="date" name="filterGEQ[dateTime]" value="{{ Request::get('filterGEQ')['dateTime'] ?? null }}">
                                </label>
                                <label class="label">
                                    <span class="label__title">Покупки до</span>
                                    <input class="input" type="date" name="filterLEQ[dateTime]" value="{{ Request::get('filterLEQ')['dateTime'] ?? null }}">
                                </label>
                            </div>
                        </details>
                        <details class="details receipt-get-details" @empty(Request::get('receipt-organization')) open @endempty>
                            ...
                            <div class="receipt-get-details__content">
                                <label class="label">
                                    ...
                                    <input class="input" type="text" name="filterLIKE[user]" value="{{ Request::get('filterLIKE')['user'] ?? null }}">
                                </label>
                                <label class="label">
                                    <span class="label__title">ИНН</span>
                                    <input class="input" type="number" name="filterLIKE[userInn]" value="{{ Request::get('filterLIKE')['userInn'] ?? null }}">
                                </label>
                                <label class="label">
                                    <span class="label__title">Адрес</span>
                                    <input class="input" type="text" name="filterLIKE[retailPlaceAddress]" value="{{ Request::get('filterLIKE')['retailPlaceAddress'] ?? null }}">
                                </label>
                                <div class="label">
                                    ...
                                    <div class="checkbox-multi">
                                        ...
                                        <label class="checbox">
                                            <input class="checbox__input" value="{{ $item->id }}" @checked(array_search($item->id, explode(',', Request::get('filterIN')['taxationType'] ?? '')) !== false) type="checkbox">
                                            <span class="checbox__icon"></span>
                        ...
                        <details class="details receipt-get-details" @empty(Request::get('receipt-total')) open @endempty>
                            ...
                            <div class="receipt-get-details__content">
                                ...
                                <label class="checbox">
                                    <input class="checbox__input" name="no_nds_only" @checked(Request::get('no_nds_only')) type="checkbox">
                                    <span class="checbox__icon"></span>
                        ...
                        <details class="details receipt-get-details" @empty(Request::get('receipt-fiscal')) open @endempty>
                            ...
                            <div class="receipt-get-details__content">
                                <label class="label">
                                    ...
                                    <input class="input" type="number" name="filterLIKE[fiscalDriveNumber]" value="{{ Request::get('filterLIKE')['fiscalDriveNumber'] ?? null }}">
                                </label>
                                <label class="label">
                                    <span class="label__title">Номер фиксального документа</span>
                                    <input class="input" type="number" name="filterLIKE[fiscalDocumentNumber]" value="{{ Request::get('filterLIKE')['fiscalDocumentNumber'] ?? null }}">
                                </label>
                                <label class="label">
                                    <span class="label__title">Фиксального признак документа</span>
                                    <input class="input" type="number" name="filterLIKE[fiscalDocumentFormatVer]" value="{{ Request::get('filterLIKE')['fiscalDocumentFormatVer'] ?? null }}">
                                </label>
                                <label class="label">
