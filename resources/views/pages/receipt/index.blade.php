        ...
        <div class="container">
            <div class="receipt-get__container">
                ...
                <div class="receipt-get__content">
                    <form class="receipt-get-many-add" action="" method="POST">
                        <input class="receipt-get-many-add__values" type="text" hidden>
                        <button class="link receipt-get-many-add__btn">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="rgb(255, 160, 0)" fill="rgb(255, 160, 0)" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg><span>Добавить в сделку</span>
                        </button>
                    </form>
