                ...
                <div class="receipt-get__content">
                    ...
                    <div class="receipt-item _active">
                        <div class="receipt-item__top">
                            ...
                            <svg class="receipt-item__star @if ($receipt->folder_receipts->where('receipt_id', $receipt->id)->count()) _active @endif"
                                data-id="{{ $receipt->id }}" width="16" height="16" viewBox="0 0 24 24"
