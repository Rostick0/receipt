    ...
    <div class="okved-mutation">
        <div class="container">
            <div class="okved-mutation__container">
                <form class="form okved-mutation__form" action="{{ route('receipt.update', ['receipt' => $receipt->id]) }}" method="POST">
                    @csrf
                    ...
                    <div class="form__inputs">
                        <div class="form__col-2">
                            <label class="label">
                                ...
                                <input class="input" type="datetime-local" name="dateTime" value="{{ old('dateTime') ?? $receipt->dateTime }}">
                                @error('dateTime')
