        ...
        <div>
            <details class="details receipt-get-details" @empty(Request::get('receipt-position')) open @endempty>
                ...
                <input class="checkbox__summary" type="checkbox" name="receipt-position"
                    @checked(!empty(Request::get('receipt-position'))) hidden>
                    ...
                    <div class="receipt-get__col">
                        <label class="label">
                            ...
                            <input class="input" type="number" name="filterGEQ[products.price]" step="0.01"
                                @if(isset(Request::get('filterGEQ')['products.price']))
                                value="{{ Request::get('filterGEQ')['products.price'] }}" @endif>
                        </label>
                        <label class="label">
                            <span class="label__title">Цена до</span>
                            <input class="input" type="number" name="filterLEQ[products.price]" step="0.01"
                                @if(isset(Request::get('filterLEQ')['products.price']))
                                value="{{ Request::get('filterLEQ')['products.price'] }}" @endif>
                        </label>
                    </div>
                    <div class="receipt-get__col">
                        <label class="label">
                    ...
                    <div class="receipt-get__col">
                        <label class="label">
                            ...
                            <input class="input" type="number" name="filterGEQ[products.sum]" step="0.01"
                                @if(isset(Request::get('filterGEQ')['products.sum']))
                                value="{{ Request::get('filterGEQ')['products.sum'] }}" @endif>
                        </label>
                        <label class="label">
                            <span class="label__title">Сумма до</span>
                            <input class="input" type="number" name="filterLEQ[products.sum]" step="0.01"
                                @if(isset(Request::get('filterLEQ')['products.sum']))
                                value="{{ Request::get('filterLEQ')['products.sum'] }}" @endif>
                        </label>
                    </div>
                </div>
            </details>
            <details class="details receipt-get-details" @empty(Request::get('receipt-data')) open @endempty>
                ...
                <input class="checkbox__summary" type="checkbox" name="receipt-data"
                    @checked(!empty(Request::get('receipt-data'))) hidden>
                <div class="receipt-get-details__content">
                    <label class="label">
                    ...
                    <div class="label">
                        ...
                        <div class="checkbox-multi">
                            ...
                            <label class="checbox">
                                ...
                                explode(',',
                                Request::get('filterIN')['taxationType'] ?? '')) !== false) type="checkbox">
                                <span class="checbox__icon"></span>
            ...
            <details class="details receipt-get-details" @empty(Request::get('receipt-total')) open @endempty>
                ...
                <input class="checkbox__summary" type="checkbox" name="receipt-total"
                    @checked(!empty(Request::get('receipt-total'))) hidden>
                <div class="receipt-get-details__content">
                    <div class="receipt-get__col">
                        <label class="label">
                            <span class="label__title">Итого от</span>
                            <input class="input" type="number" name="filterGEQ[totalSum]" step="0.01"
                                @if(isset(Request::get('filterGEQ')['totalSum']))
                                value="{{ Request::get('filterGEQ')['totalSum']}}" @endif>
                        </label>
                        <label class="label">
                            <span class="label__title">Итого по</span>
                            <input class="input" type="number" name="filterLEQ[totalSum]" step="0.01"
                                @if(isset(Request::get('filterLEQ')['totalSum']))
                                value="{{ Request::get('filterLEQ')['totalSum']}}" @endif>
                        </label>
                    </div>
                    <div class="receipt-get__col">
                        <label class="label">
                            ...
                            <input class="input" type="number" name="filterGEQ[cashTotalSum]" step="0.01"
                                @if(isset(Request::get('filterGEQ')['cashTotalSum']))
                                value="{{ Request::get('filterGEQ')['cashTotalSum']}}" @endif>
                        </label>
                        <label class="label">
                            <span class="label__title">Наличные по</span>
                            <input class="input" type="number" name="filterLEQ[cashTotalSum]" step="0.01"
                                @if(isset(Request::get('filterLEQ')['cashTotalSum']))
                                value="{{ Request::get('filterLEQ')['cashTotalSum']}}" @endif>
                        </label>
                    </div>
                    <div class="receipt-get__col">
                        <label class="label">
                            ...
                            <input class="input" type="number" name="filterGEQ[creditSum]" step="0.01"
                                @if(isset(Request::get('filterGEQ')['creditSum']))
                                value="{{ Request::get('filterGEQ')['creditSum']}}" @endif>
                        </label>
                        <label class="label">
                            <span class="label__title">Карта по</span>
                            <input class="input" type="number" name="filterLEQ[creditSum]" step="0.01"
                                @if(isset(Request::get('filterLEQ')['creditSum']))
                                value="{{ Request::get('filterLEQ')['creditSum']}}" @endif>
                        </label>
                    </div>
                    <label class="checbox">
            ...
            <details class="details receipt-get-details" @empty(Request::get('receipt-fiscal')) open @endempty>
                ...
                <input class="checkbox__summary" type="checkbox" name="receipt-fiscal"
                    @checked(!empty(Request::get('receipt-fiscal'))) hidden>
                <div class="receipt-get-details__content">
                    <label class="label">
                    ...
                    <label class="label">
                        ...
                        <select class="input" type="number" name="filterEQ[operationType]">
                            ...
                            <option @selected($item->id == Request::get('filterEQ')['operationType'])
