...
class UpdateReceiptRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => 'nullable|numeric|max:20',
            'fiscalDocumentFormatVer' => 'nullable|numeric|max:20',
            'fiscalDocumentNumber' => 'required|numeric|max:20',
            'fiscalDriveNumber' => 'required|numeric|max:20',
            'fiscalSign' => 'required|numeric|max:20',
